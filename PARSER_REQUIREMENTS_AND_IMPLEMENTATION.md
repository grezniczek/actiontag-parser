...
Custom Record Label, Custom Event Label, and Custom Repeating Instrument Label's
...
resolve. Field Annotation is intentionally click-only, so it is not part of
that duplicate-event path.
