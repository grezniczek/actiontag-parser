...
return [
    ...
    'malformed_if_source_coverage' => [
        'annotation' => 'Before @IF([a], @HIDDEN) after',
        'mode' => 'diagnostic',
        'options' => ['include_text_segments' => true],
        'tag_names' => [],
        'node_types' => ['text', 'candidate', 'text'],
        'node_source_covers' => true,
        'diagnostic_codes' => ['if_missing_else'],
    ],
    ...
    'unterminated_if_source_coverage' => [
        'annotation' => '@IF([a], @HIDDEN',
        'mode' => 'diagnostic',
        'options' => ['include_text_segments' => true],
        'tag_names' => [],
        'node_types' => ['candidate'],
        'node_source_covers' => true,
        'diagnostic_codes' => ['unterminated_if'],
    ],
